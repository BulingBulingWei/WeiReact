...
type ElementInformation = HTMLElementInformation | TextElementInformation | FunctionElementInformation;
...
function render(element: ElementInformation, container: HTMLElement) {
    ...
    function createDOM(element: HTMLElementInformation | TextElementInformation): HTMLElement | Text {
...
function useState(initial: any) {
    ...
    if (workInProgressFiber.hooks.length <= hookIndex) {
        ...
        workInProgressFiber.hooks[hookIndex].actions.forEach((fun) => {
            workInProgressFiber.hooks[hookIndex].state = fun(workInProgressFiber.hooks[hookIndex].state);
        });
